...
[_LOWER] = LAYOUT_planck_grid(
		...
		_______ ,_______ ,_______ ,_______ ,_______ ,_______ ,KC_NO   ,FN_RAZ2 ,KC_MNXT ,KC_VOLD ,KC_VOLU ,KC_MPLY ),
...
[_RAISE] = LAYOUT_planck_grid(
		...
		_______ ,_______ ,_______ ,_______ ,FN_LOW2 ,_______ ,KC_NO   ,_______ ,_______ ,KC_PGDN ,KC_PGUP ,_______ ),
